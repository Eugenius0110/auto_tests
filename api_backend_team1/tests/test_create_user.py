...
import pytest
from endpoints.signup import SignupUser
from endpoints.confirm_code import ConfirmCode
from endpoints.set_password import SetPassword
from payloads.create_user import SignUpPayload
from payloads.create_user import ConfirmCodePayload
from payloads.create_user import SetPasswordPayload
import models.create_user as models
from http import HTTPStatus


@pytest.mark.parametrize('payload, status_code, model', [(
        SignUpPayload.payload_signup,
        HTTPStatus.CREATED,
        models.SignUpModel201)])
